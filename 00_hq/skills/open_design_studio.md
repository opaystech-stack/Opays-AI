# Skill : Open Design Studio (Prototypage & UI Premium)

## Rôle
Capacité à concevoir, maquetter et coder des interfaces web modernes à haute densité d'information dans l'Open Design Studio d'Opays Tech.

## Principes de Design
1. **Intégration du Design System :** Utiliser systématiquement les variables CSS du preset choisi (ex: `--primary`, `--accent`, `--bg`, `--card-bg`, `--text`, `--border`, `--radius`, `--shadow`).
